...
class BK_Unit_Tests_Bootstrap {
    ...
    public function includes() {
        ...
        // Test Cases
        require_once( $this->tests_dir . '/framework/class-bk-unit-test-case-with-store.php' );

        // Helpers
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-date.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-booking-product.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-availability-ranges.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-prices.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-person-types.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-extra-costs.php' );
        require_once( $this->tests_dir . '/framework/helpers/class-bk-helper-booking.php' );
    }
