...
if ( ! class_exists( 'HRW_WooCommerce_Log' ) ) {

    /**
     * HRW_WooCommerce_Log Class.
     */
    class HRW_WooCommerce_Log {
         ...
         */
        public static function log( $message , $source = 'hrw-wallet-upgrade' , $level = 'info' , $context = array() ) {
            if ( empty( self::$log ) ) {
