...
if( ! class_exists( 'HRW_Auto_Topup_Failure_Notification' ) ) {

    /**
     * Class HRW_Auto_Topup_Failure_Notification
     */
    class HRW_Auto_Topup_Failure_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'auto_topup_failure' ;
            $this->section = 'module' ;
            $this->title   = esc_html__( 'Auto Top-up Failure' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_auto_topup_is_failed' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} – Wallet Auto Top-up Funds addition Failure on {site_name}' ;
        }
...
Wallet Auto Top-up on {site_name} is unsuccessful due to {failure_reason}. Please re-authenticate to add funds automatically. Click here to go to Wallet dashboard and re-authenticate.
...
Thanks." ;
        ...
        public function trigger( $args ) {
            ...
            if( is_object( $args[ 'auto_topup' ] ) && is_object( $args[ 'wallet' ] ) ) {
                ...
                $this->placeholders[ '{failure_reason}' ] = esc_html( $args[ 'failure_reason' ] ) ;
        ...
        public function get_shortcodes() {
            ...
            return array(
                ...
                '{failure_reason}' => array( 'where' => esc_html__( 'Email' , HRW_LOCALE ) ,
                    'usage' => esc_html__( 'Displays the Failure Reason' , HRW_LOCALE )
                ) ,
