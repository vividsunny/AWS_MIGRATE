...
/**
 * Admin- Wallet Fund Expired
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Admin_Funds_Expired_Notification' ) ) {

    /**
     * Class HRW_Admin_Funds_Expired_Notification
     */
    class HRW_Admin_Funds_Expired_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'admin_funds_expired' ;
            $this->section = 'general' ;
            $this->title   = esc_html__( 'Admin - Wallet Funds Expired' , HRW_LOCALE ) ;
...
One of your Customer's {username} Wallet Balance got expired on {expiry-date}. The user had {wallet-balance} on their wallet at the time of expiry.
...
Thanks." ;
        ...
        public function get_enabled() {
            ...
            return get_option( 'hr_wallet_email_expired_admin_enable' ) ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'admin_funds_expired_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                'type' => 'sectionend' ,
                'id'   => 'admin_funds_expired_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'admin_funds_expired_sms_options' ,
                        ) ;
                $settings[] = array(
