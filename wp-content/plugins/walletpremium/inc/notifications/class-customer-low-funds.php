...
/**
 * Customer- Wallet Low Funds
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Low_Funds_Notification' ) ) {

    /**
     * Class HRW_Customer_Low_Funds_Notification
     */
    class HRW_Customer_Low_Funds_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_low_funds' ;
            $this->section = 'general' ;
            $this->title   = esc_html__( 'Customer - Low Wallet Funds' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_wallet_updated' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
        ...
        public function get_default_subject() {
            ...
            return 'Low Wallet Balance on {site_name}' ;
        }
...
Your Wallet Balance is runnning low. Please use the link below to Top-up your Wallet.
{wallet-topup-link}
...
Thanks.' ;
        ...
        public function get_enabled() {
            ...
            return get_option( 'hr_wallet_email_low_wallet_user_enable' , 'no' ) ;
        }
        ...
        public function trigger( $wallet_id , $wallet_object = false ) {
            ...
            //return if threshold value is empty
            $low_threshold_value = ( float ) get_option( 'hrw_advanced_low_wallet_amount_limit' , '' ) ;
            if ( ! $low_threshold_value )
                return ;
            ...
            //return if greater than low fund balance
            if ( $wallet_object->get_available_balance() > $low_threshold_value )
                return ;
            
            if( ! apply_filters( 'hrw_validate_low_funds_notification' , true , $wallet_object ) ) {
                return ;
            }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_low_funds_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_low_funds_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'customer_low_funds_sms_options' ,
                        ) ;
                $settings[] = array(
