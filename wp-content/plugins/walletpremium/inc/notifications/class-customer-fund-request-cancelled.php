...
/**
 * Customer- Fund Request Cancelled
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Fund_Request_Cancelled_Notification' ) ) {

    /**
     * Class HRW_Customer_Fund_Request_Cancelled_Notification
     */
    class HRW_Customer_Fund_Request_Cancelled_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_fund_request_cancelled' ;
            $this->section = 'module' ;
            $this->title   = esc_html__( 'Customer - Fund Request Cancelled' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_after_fund_request_cancel_response' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} – Fund Transfer Request Cancelled' ;
        }
...
A Fund Transfer request for {transfer_amount} from {sender} has been cancelled." ;
        }
        ...
        public function get_sms_default_message() {
            ...
            return 'A Fund Transfer request for {transfer_amount} from {sender}has been cancelled.' ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_cancelled_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_cancelled_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'customer_request_cancelled_sms_options' ,
                        ) ;
                $settings[] = array(
