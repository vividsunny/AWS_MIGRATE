...
/**
 * Customer- Fund Request Received
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Fund_Request_Received_Notification' ) ) {

    /**
     * Class HRW_Customer_Fund_Request_Received_Notification
     */
    class HRW_Customer_Fund_Request_Received_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_fund_request_received' ;
            $this->section = 'module' ;
            $this->title   = esc_html__( 'Customer - Fund Request Received' , HRW_LOCALE ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} – New Fund Transfer Request Received' ;
        }
...
A new Fund Transfer request for {transfer_amount} has been submitted by {sender}. Please visit your wallet dashboard for more details." ;
        }
        ...
        public function get_sms_default_message() {
            ...
            return 'You have received a new Fund Transfer request for {transfer_amount}  by {sender}. Please visit your wallet dashboard for more details.' ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_received_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_received_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'customer_request_received_sms_options' ,
                        ) ;
                $settings[] = array(
