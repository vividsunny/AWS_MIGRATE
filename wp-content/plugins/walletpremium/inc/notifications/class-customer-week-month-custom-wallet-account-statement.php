...
/**
 * Week-Month-Wallet Account Statement
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Week_Month_Wallet_Account_Statement_Notification' ) ) {

    /**
     * Class HRW_Customer_Week_Month_Wallet_Account_Statement_Notification
     */
    class HRW_Customer_Week_Month_Wallet_Account_Statement_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_week_month_wallet_account_statement' ;
            $this->section = 'module' ;
            $this->title   = esc_html__( 'Customer - Wallet Account Statement (Week , Month, Custom)' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_customer_week_wallet_account_statement_notification' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
            add_action( sanitize_key( $this->plugin_slug . '_customer_month_wallet_account_statement_notification' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
            add_action( sanitize_key( $this->plugin_slug . '_customer_custom_wallet_account_statement_notification' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
        ...
        public function get_default_subject() {
            ...
            return 'Wallet Statement for the period from ({from_date} to {to_date})' ;
        }
...
Thanks." ;
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'week_month_wallet_account_statement_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'week_month_wallet_account_statement_notifications_options' ,
                    ) ;
