...
/**
 * Customer- Gift Card Sent
 */
if ( ! defined ( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists ( 'HRW_Customer_Gift_Card_Sent_Notification' ) ) {

    /**
     * Class HRW_Customer_Gift_Card_Sent_Notification
     */
    class HRW_Customer_Gift_Card_Sent_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'hrw_customer_gift_card_sent' ;
            $this->section = 'module' ;
            $this->title   = esc_html__ ( 'Customer - Gift Card Sent' , HRW_LOCALE ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} - Gift Card Sent Successfully' ;
        }
...
You have successfully sent the Gift Card {gift_card_code} worth of {gift_card_amount} to {receiver} on {sent_date}. You will be notified once they redeemed the code on {site_link}.
...
Thanks.' ;
        ...
        public function get_sms_default_message() {
            ...
            return 'Gift Card worth of {gift_card_amount} has been successfully sent to {receiver}.' ;
        }
