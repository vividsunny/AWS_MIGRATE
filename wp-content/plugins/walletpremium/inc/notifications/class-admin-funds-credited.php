...
/**
 * Admin- Wallet Fund Credited
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Admin_Funds_Credited_Notification' ) ) {

    /**
     * Class HRW_Admin_Funds_Credited_Notification
     */
    class HRW_Admin_Funds_Credited_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'admin_funds_credited' ;
            $this->section = 'general' ;
            $this->title   = esc_html__( 'Admin - Wallet Funds Credited' , HRW_LOCALE ) ;
...
{wallet-transaction-amount} has been successfully added to your customer's wallet on {date}. Your Cusomer's {username} Wallet balance is {wallet-balance}.
...
Thanks" ;
        ...
        public function get_enabled() {
            ...
            return get_option( 'hr_wallet_email_add_funds_admin_enable' ) ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'admin_funds_credited_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'admin_funds_credited_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'admin_funds_credited_sms_options' ,
                        ) ;
                $settings[] = array(
