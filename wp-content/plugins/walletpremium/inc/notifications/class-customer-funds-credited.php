...
/**
 * Customer- Wallet Fund Credited
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Funds_Credited_Notification' ) ) {

    /**
     * Class HRW_Customer_Funds_Credited_Notification
     */
    class HRW_Customer_Funds_Credited_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_funds_credited' ;
            $this->section = 'general' ;
            $this->title   = esc_html__( 'Customer - Wallet Funds Credited' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_after_wallet_amount_credited' ) , array( $this , 'trigger' ) , 10 , 2 ) ;
        ...
        public function get_default_subject() {
            ...
            return 'Wallet Funds Successfully added on {site_name}' ;
        }
...
{wallet-transaction-amount} has been successfully added to your wallet on {date}. Your current Wallet balance is {wallet-balance}.
Thanks.' ;
        }
        ...
        public function get_sms_default_message() {
            ...
            return 'Customer Fund Successfully Credited' ;
        }
        ...
        public function get_enabled() {
            ...
            return get_option( 'hr_wallet_email_add_funds_user_enable' , 'no' ) ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_funds_credited_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_funds_credited_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'customer_funds_credited_sms_options' ,
                        ) ;
                $settings[] = array(
