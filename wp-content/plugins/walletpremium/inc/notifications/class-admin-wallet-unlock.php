...
/**
 * Admin- Scheduled Wallet Unlock
 */
if( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if( ! class_exists( 'HRW_Admin_Wallet_Unlock_Notification' ) ) {

    /**
     * Class HRW_Admin_Wallet_Unlock_Notification
     */
    class HRW_Admin_Wallet_Unlock_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'admin_wallet_unlock' ;
            $this->section = 'general' ;
            $this->title   = esc_html__( 'Admin - Wallet Unlock' , HRW_LOCALE ) ;
...
The Wallet of your customer {username} has
 been unlocked on {date}. The Customer currently has {wallet-balance} in their account
...
Thanks." ;
        ...
        public function get_enabled() {
            ...
            return get_option( 'hr_wallet_email_unblock_admin_enable' ) ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'admin_wallet_unlock_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'admin_wallet_unlock_notifications_options' ,
                    ) ;
            ...
            if( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'admin_wallet_unlock_sms_options' ,
                        ) ;
                $settings[] = array(
