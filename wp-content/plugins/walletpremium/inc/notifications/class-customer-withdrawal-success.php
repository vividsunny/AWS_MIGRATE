...
if ( ! class_exists ( 'HRW_Customer_Withdrawal_Success_Notification' ) ) {

    /**
     * Class HRW_Customer_Withdrawal_Success_Notification
     */
    class HRW_Customer_Withdrawal_Success_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_withdrawal_success' ;
            $this->section = 'module' ;
            $this->title   = esc_html__ ( 'Customer - Withdrawal Success' , HRW_LOCALE ) ;

            add_action ( sanitize_key ( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array ( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action ( sanitize_key ( $this->plugin_slug . '_withdrawal_success_notification' ) , array ( $this , 'trigger' ) , 10 , 2 ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} Wallet Withdrawal Success' ;
        }
...
Your Withdrawal request of wallet funds has been processed successfully. Please find the details below
...
Thanks" ;
        ...
        public function get_sms_default_message() {
            ...
            return 'Your Withdrawal request of wallet funds has been processed Successfully.' ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array (
                ...
                'id'    => 'customer_withdrawal_success_shortcodes' ,
                    ) ;
            $settings[] = array (
            ...
            $settings[] = array (
                ...
                'id'    => 'customer_withdrawal_success_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled () ) {
                ...
                $settings[] = array (
                    ...
                    'id'    => 'customer_withdrawal_success_sms_options' ,
                        ) ;
                $settings[] = array (
