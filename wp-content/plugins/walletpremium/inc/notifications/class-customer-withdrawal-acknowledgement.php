<?php
/**
 * Customer- Withdrawal Acknowledgement
 */
if ( ! defined ( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists ( 'HRW_Customer_Withdrawal_Acknowledgement_Notification' ) ) {

    /**
     * Class HRW_Customer_Withdrawal_Acknowledgement_Notification
     */
    class HRW_Customer_Withdrawal_Acknowledgement_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_withdrawal_acknowledgement' ;
            $this->section = 'module' ;
            $this->title   = esc_html__ ( 'Customer - Withdrawal Acknowledgement' , HRW_LOCALE ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} Wallet Withdrawal Acknowledgement' ;
        }
...
Your Withdrawal request of wallet funds has been submitted successfully. Please find the details below
...
Thanks" ;
        ...
        public function get_sms_default_message() {
            ...
            return 'Your Withdrawal request of wallet funds has been submitted Successfully.' ;
        }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array (
                ...
                'id'    => 'customer_withdrawal_acknowledgement_shortcodes' ,
                    ) ;
            $settings[] = array (
            ...
            $settings[] = array (
                ...
                'id'    => 'customer_withdrawal_acknowledgement_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled () ) {
                ...
                $settings[] = array (
                    ...
                    'id'    => 'customer_withdrawal_acknowledgement_sms_options' ,
                        ) ;
                $settings[] = array (
