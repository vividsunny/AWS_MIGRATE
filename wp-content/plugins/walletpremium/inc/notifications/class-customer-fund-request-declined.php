...
/**
 * Customer- Fund Request Declined
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'HRW_Customer_Fund_Request_Declined_Notification' ) ) {

    /**
     * Class HRW_Customer_Fund_Request_Declined_Notification
     */
    class HRW_Customer_Fund_Request_Declined_Notification extends HRW_Notifications {
        ...
        public function __construct() {
            ...
            $this->id      = 'customer_fund_request_declined' ;
            $this->section = 'module' ;
            $this->title   = esc_html__( 'Customer - Fund Request Declined' , HRW_LOCALE ) ;

            add_action( sanitize_key( $this->plugin_slug . '_admin_field_' . $this->id . '_shortcodes_table' ) , array( $this , 'output_shortcodes_table' ) ) ;

            // Triggers for this email.
            add_action( sanitize_key( $this->plugin_slug . '_after_fund_request_decline_response' ) , array( $this , 'trigger' ) , 10 , 1 ) ;
        ...
        public function get_default_subject() {
            ...
            return '{site_name} – Fund Transfer Request Declined' ;
        }
...
Your Fund Transfer request of {transfer_amount} to {receiver} has been declined." ;
        }
        ...
        public function get_sms_default_message() {
            ...
            return 'Your Fund Transfer request of {transfer_amount} to {receiver} has been declined.' ;
        }
        ...
        public function trigger( $args ) {
            ...
            if ( is_object( $wallet_object ) ) {
                ...
                $this->placeholders[ '{receiver}' ]        = get_userdata( $args[ 'sender_id' ] )->display_name ;
        ...
        public function settings_options_array() {
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_declined_shortcodes' ,
                    ) ;
            $settings[] = array(
            ...
            $settings[] = array(
                ...
                'id'    => 'customer_request_declined_notifications_options' ,
                    ) ;
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array(
                    ...
                    'id'    => 'customer_request_declined_sms_options' ,
                        ) ;
                $settings[] = array(
