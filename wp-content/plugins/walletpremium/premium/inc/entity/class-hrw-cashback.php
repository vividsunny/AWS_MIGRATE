...
if ( ! class_exists( 'HRW_CASHBACK' ) ) {

    /**
     * HRW_CASHBACK Class.
     */
    class HRW_CASHBACK extends HRW_Post {

        /**
         * Post Type
         */
        protected $post_type = HRWP_Register_Post_Types::CASHBACK_POSTTYPE ;
        ...
        /**
         * Order Rules to get Cashback Values
         */
        protected $order_rule = array() ;

        /**
         * Wallet Rules to get Cashback Values
         */
        protected $wallet_rule = array() ;
        ...
        public function set_order_rule( $value ) {
            $this->order_rule = $value ;
        }
        ...
        public function set_wallet_rule( $value ) {
            $this->wallet_rule = $value ;
        }
        ...
        public function get_wallet_rule() {
