<div class="tg_settings_tabs_content">
  <div class="chatty-mango-settings-columns">
    ...
    <div>
      ...
      <p><?php printf( __( 'The easiest way to get going is described in <a %s>Get started in 3 easy steps</a>.', 'tag-groups' ), 'href="' . admin_url( 'admin.php?page=tag-groups-settings-first-steps' ) . '"' ) ?></p>
    </div>
