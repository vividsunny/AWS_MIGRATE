<div class="tg_settings_tabs_content">
  ...
  <form method="POST" action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ) ?>">
    ...
    <p>
      ...
      <span class="dashicons dashicons-editor-help chatty-mango-help-icon" data-topic="filter-tags"></span>
    </p>
    <div class="chatty-mango-help-container chatty-mango-help-container-filter-tags" style="display:none;">
      <?php _e( 'Add a filter to the list of tags. Disable it here if it conflicts with other plugins or themes.', 'tag-groups' ) ?>
    </div>
