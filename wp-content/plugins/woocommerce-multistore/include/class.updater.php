                     ...
                     if (is_object($response) && !empty($response)) // Feed the update data into WP updater
                         {
                             ...
                             $response->banners = array(
                                '1x' => WOO_MSTORE_URL . '/assets/images/banner-772x250.jpg',
                                '2x' => WOO_MSTORE_URL . '/assets/images/banner-1544x500.jpg',
                             );
                             $response->icons = array(
                                '1x' => WOO_MSTORE_URL . '/assets/images/icon-128x128.jpg',
                                '2x' => WOO_MSTORE_URL . '/assets/images/icon-256x256.jpg',
                             );
                     ...
                     if (is_object($response) && !empty($response)) // Feed the update data into WP updater
                         {
                             ...
                             $response->banners = array(
                                 'low' => WOO_MSTORE_URL . '/assets/images/banner-772x250.jpg',
                                 'high' => WOO_MSTORE_URL . '/assets/images/banner-1544x500.jpg',
                             );
