...
<?php do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
    ...
    <p><?php printf( esc_html__( "Hi!, we would like to inform you that the highest bid for the following product doesn't exceed the minimum reserve price :", 'yith-auctions-for-woocommerce' ));?></p>
