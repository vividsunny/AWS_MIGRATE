...
<?php do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
	...
	<p><?php esc_html_e( 'Another user just overbidded your maximum bid', 'yith-auctions-for-woocommerce' ); ?></p>
	<p><?php printf( esc_html__( "Hi!  %s, Another user has just overbidded your maximum bid for the product:", 'yith-auctions-for-woocommerce' ),
