...
if ( ! class_exists( 'YITH_WCACT_Email_End_Auction' ) ) {
    ...
    class YITH_WCACT_Email_End_Auction extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = esc_html__('​Auctions - The Auction is about to end', 'yith-auctions-for-woocommerce');
            $this->title = esc_html__('​Auctions - End', 'yith-auctions-for-woocommerce');

            $this->customer_email = true;

            // this is the description in WooCommerce email settings
            $this->description = esc_html__('​Can be emailed when the auction is about to end', 'yith-auctions-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__('The Auction is about to end', 'yith-auctions-for-woocommerce');
            $this->subject =  esc_html__('The Auction is about to end', 'yith-auctions-for-woocommerce');
