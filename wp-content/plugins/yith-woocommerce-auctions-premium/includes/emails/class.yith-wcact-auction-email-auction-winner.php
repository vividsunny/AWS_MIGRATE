...
if ( !class_exists( 'YITH_WCACT_Email_Auction_Winner' ) ) {
    ...
    class YITH_WCACT_Email_Auction_Winner extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->description = esc_html__( '​Can be emailed to user who won the auction when it is finished', 'yith-auctions-for-woocommerce' );

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__( 'Auction Winner', 'yith-auctions-for-woocommerce' );

            $this->subject = esc_html__( 'Auction Winner', 'yith-auctions-for-woocommerce' );
