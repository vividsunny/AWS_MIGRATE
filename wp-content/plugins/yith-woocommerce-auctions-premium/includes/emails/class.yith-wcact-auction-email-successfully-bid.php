...
if ( ! class_exists( 'YITH_WCACT_Email_Successfully_Bid' ) ) {
    ...
    class YITH_WCACT_Email_Successfully_Bid extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = esc_html__('​Auctions - Successfully bid', 'yith-auctions-for-woocommerce');

            $this->customer_email = true;

            // this is the description in WooCommerce email settings
            $this->description = esc_html__('​Can be emailed when the customer bid successfully', 'yith-auctions-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__('Your bid was added successfully', 'yith-auctions-for-woocommerce');
            $this->subject = esc_html__('Your bid was added successfully', 'yith-auctions-for-woocommerce');
