...
if ( ! class_exists( 'YITH_WCACT_Email_Delete_Bid_Admin' ) ) {
    ...
    class YITH_WCACT_Email_Delete_Bid_Admin extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = esc_html__('​Auctions - Delete Bid Admin', 'yith-auctions-for-woocommerce');

            // this is the description in WooCommerce email settings
            $this->description = esc_html__('​Can be sent when a bid was removed', 'yith-auctions-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__('Auction bid removed', 'yith-auctions-for-woocommerce');

            $this->subject = esc_html__('Auction bid removed', 'yith-auctions-for-woocommerce');
