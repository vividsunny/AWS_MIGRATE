...
if ( ! class_exists( 'YITH_WCACT_Vendor_Email_Without_Bid' ) ) {
    ...
    class YITH_WCACT_Vendor_Email_Without_Bid extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = esc_html__('​Auctions - Without bid (to vendor)', 'yith-auctions-for-woocommerce');

            // this is the description in WooCommerce email settings
            $this->description = esc_html__('​Can be emailed when the auction has finished, and the product doesn\'t have any bid ', 'yith-auctions-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = esc_html__('The product doesn\'t have any bid', 'yith-auctions-for-woocommerce');

            $this->subject = esc_html__('The product doesn\'t have any bid', 'yith-auctions-for-woocommerce');
