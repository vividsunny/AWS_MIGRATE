...
function wf_ups_basic_pre_activation_check(){
	if ( is_plugin_active('ups-woocommerce-shipping/ups-woocommerce-shipping.php') ){
		...
		wp_die(__("Is everything fine? You already have the Premium version installed in your website. For any issues, kindly raise a ticket via <a target='_blank' href='https://support.pluginhive.com/'>support.pluginhive.com</a>", "ups-woocommerce-shipping"), "", array('back_link' => 1 ));
	}
}
	...
	class UPS_WooCommerce_Shipping {
		...
		public function wf_plugin_action_links( $links ) {
			$plugin_links = array(
				...
				'<a href="https://www.pluginhive.com/product/woocommerce-ups-shipping-plugin-with-print-label/" target="_blank">' . __( 'Premium Upgrade', 'ups-woocommerce-shipping' ) . '</a>',
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://bitbucket.org/pluginhive/ups-woocommerce-shipping-method/',
	__FILE__,
