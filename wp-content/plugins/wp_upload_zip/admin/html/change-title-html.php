...
<?php 
    ...
    //$file_url = '/nas/content/live/popupcomicshop/wp-content/uploads/2019/08/Title_Changes_20180810.csv';
    ...
    if(!$error){
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                if( $url != ''){
                    run_title_change_import($start_pos,$url);
                }
...
<div class="col-md-12">
    ...
    <div class="woocommerce-progress-form-wrapper">
        <form class="wc-progress-form-content va-customer-import va-importer" enctype="multipart/form-data" method="post">
            ...
            <header>
                <h2>Title Change Import</h2>
                <p>This tool allows you to import change title to your store from a CSV file.</p>
            </header>
            <section>
...
<script type="text/javascript">
    ...
    function run_title_change_import($pos,fileurl=''){
        jQuery.ajax({
            url: '<?php echo admin_url( "admin-ajax.php" );?>',
            type: 'POST',
            dataType: 'json',
            data: {
                action : 'change_product_title_import',
                startpos: $pos,
                file_url : fileurl,
            },
            success: function( response ) {
                ...
                if ( response.success ) {
                    ...
                    if(newpos == 'done'){
                        ...
                        jQuery('.import_response').prepend(message +'</br>' );
                        run_title_change_import(newpos,fileurl);
                    }
                }else{
