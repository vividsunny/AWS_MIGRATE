...
<?php 
    ...
    $file_url = '/nas/content/live/popupcomicshop/wp-content/uploads/2019/08/cancel.csv';
       ...
       // echo '$file_url--->'.$file_url;
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                if( $url != ''){
                    reproduct_cancel_import_script($start_pos,$url);
                }
...
<div class="col-md-12">
    ...
    <div class="woocommerce-progress-form-wrapper">
        <form class="wc-progress-form-content va-customer-import va-importer" enctype="multipart/form-data" method="post">
            ...
            <header>
                <h2>Reproduct Cancel Import</h2>
                <p>This tool allows you reproduct cancel import to your store from a CSV file.</p>
            </header>
            <section>
...
<script type="text/javascript">
    ...
    function reproduct_cancel_import_script($pos,fileurl=''){
        jQuery.ajax({
            url: '<?php echo admin_url( "admin-ajax.php" );?>',
            type: 'POST',
            dataType: 'json',
            data: {
                action : 'reproduct_cancel_import',
                startpos: $pos,
                file_url : fileurl,
            },
            success: function( response ) {
                ...
                if ( response.success ) {
                    ...
                    if(newpos == 'done'){
                        ...
                        jQuery('.import_response').prepend(message +'</br>' );
                        reproduct_cancel_import_script(newpos,fileurl);
                    }
                }else{
