...
<?php 
    ...
    $file_url = '/nas/content/live/popupcomicshop/wp-content/uploads/2019/08/newseries.txt';
       ...
       // echo '$file_url--->'.$file_url;
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                console.log('URL--> '+$url+' $delimiter --> '+$delimiter);

                if( $url != ''){
                    recreate_series_import_script($start_pos,$url,$delimiter);
                }
...
<div class="col-md-12">
    ...
    <div class="woocommerce-progress-form-wrapper">
        <form class="wc-progress-form-content va-customer-import va-importer" enctype="multipart/form-data" method="post">
            ...
            <header>
                <h2>Recreate New Series Import</h2>
                <p>This tool allows you recreate new series import to your store from a CSV file.</p>
            </header>
            <section>
...
<script type="text/javascript">
    ...
    function recreate_series_import_script($pos,fileurl='',delimiter=','){
        jQuery.ajax({
            url: '<?php echo admin_url( "admin-ajax.php" );?>',
            type: 'POST',
            dataType: 'json',
            data: {
                action : 'recreate_series_import',
                startpos: $pos,
                file_url : fileurl,
                delimiter : delimiter,
            },
            success: function( response ) {
                ...
                if ( response.success ) {
                    ...
                    if(newpos == 'done'){
                        ...
                        jQuery('.import_response').prepend(message +'</br>' );
                        recreate_series_import_script(newpos,fileurl,delimiter);
                    }
                }else{
