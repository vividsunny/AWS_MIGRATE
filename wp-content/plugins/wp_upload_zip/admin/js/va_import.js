;(function ( $, window ) {
	...
	var ImportForm = function( $form ) {
		...
		this.import_type        = va_import_params.import_type;
	...
	ImportForm.prototype.run_import = function() {
		...
		$.ajax( {
			...
			data: {
				...
				trans_data_file        : $this.trans_data_file,
				pos        : $this.pos,
			...
			success: function( response ) {
				if ( response.success ) {
					...
					$this.trans_data_file  = response.data.trans_data_file;
					...
					$('#va_import_log').append(response.data.va_message+'</br>');
