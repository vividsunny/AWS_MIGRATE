...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|zip|xls)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|zip|xls)$/i',
    ...
    public function get_file_extention($url) {
       // vivid( $url );
        $strings = explode('.', $url);
    ...
    protected function get_file_object($file_name) {
        if ($this->is_valid_file_object($file_name)) {
            ...
            $file->xml = $this->get_file_extention($file_name);
