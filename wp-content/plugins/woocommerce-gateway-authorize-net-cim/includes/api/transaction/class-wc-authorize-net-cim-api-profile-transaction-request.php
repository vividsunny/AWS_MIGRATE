...
class WC_Authorize_Net_CIM_API_Profile_Transaction_Request extends WC_Authorize_Net_CIM_API_Transaction_Request  {
	...
	protected function get_extra_options() {
		...
		$options = array(
			...
			'x_customer_ip'      => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'customer_ip_address' ),
			'x_currency_code'    => Framework\SV_WC_Order_Compatibility::get_prop( $this->order, 'currency', 'view' ),
