    ...
    abstract class YITH_Licence {
        ...
        public function admin_enqueue_scripts() {
            ...
            wp_localize_script( 'yit-licence', 'licence_message', array(
                                                 'error'        => sprintf( esc_html_x( 'Please, insert a valid %s', '%s = field name', 'yith-plugin-upgrade-fw' ), '%field%' ),  // sprintf must be used to avoid errors with '%field%' string in translation in .po file
