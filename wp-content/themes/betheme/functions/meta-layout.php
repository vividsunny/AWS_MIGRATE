 ...
 * Edit columns
 * --------------------------------------------------------------------------- */
if( ! function_exists( 'mfn_layout_edit_columns' ) )
{
	function mfn_layout_edit_columns( $columns )
	{
		$newcolumns = array(
			'cb' 				=> '<input type="checkbox" />',
			'title' 			=> __( 'Title', 'mfn-opts' ),
			'layout_ID' 		=> __( 'Layout ID', 'mfn-opts' ),
		);
...
add_filter( 'manage_edit-layout_columns', 'mfn_layout_edit_columns' );


/* ---------------------------------------------------------------------------
 * Custom columns
* --------------------------------------------------------------------------- */
if( ! function_exists( 'mfn_layout_custom_columns' ) )
{
	function mfn_layout_custom_columns($column)
	{
		global $post;
		switch ($column)
		{
...
add_action( 'manage_posts_custom_column',  'mfn_layout_custom_columns' );
