(function($) {
  ...
  var MfnUploadMulti = (function() {
    ...
    var multiFileFrame, multiFileFrameOpen, multiFileFrameSelect,
    ...
    function uiSortable() {
      ...
      $(selector).on('mouseenter', '.gallery-container', function(e) {
    ...
    function openMediaGallery() {
      $(selector).on('click', '.upload-add', function(event) {
    ...
    multiFileFrameOpen = function() {
      ...
      var handle = $(multiFileFrame.modal.clickedOpenerEl),
    ...
    function attachRemoveAction() {
      $(selector).on('click', '.upload-remove.single', function(event) {
    ...
    function attachRemoveAllAction() {
      $(selector).on('click', '.upload-remove.all', function(event) {
