			...
			echo '<div class="hover_box hover_box_product" ontouchstart="this.classList.toggle(\'hover\');" >';
				echo '<a href="'. apply_filters( 'the_permalink', get_permalink() ) .'">';
					...
					if($info)
					{
						...
						echo '<img src="'.$final_thumbnail.'" alt="Placeholder" class="woocommerce-placeholder wp-post-image 123" width="300" height="">';
					}elseif ($zip_file) {
						# code...
						...
						echo '<img src="'.$final_thumbnail.'" alt="Placeholder" class="woocommerce-placeholder wp-post-image zip-123" width="300" height="">';
					}else{
			...
			echo '<div class="image_frame scale-with-grid product-loop-thumb" ontouchstart="this.classList.toggle(\'hover\');">';
				...
				echo '<a href="'. apply_filters( 'the_permalink', get_permalink() ) .'">';
					...
					if(!empty($thumbnailurl))
					{
        				...
        				echo '<img src="'.$thumbnail.'" alt="PostThumbnail" class="PostThumbnail woocommerce-placeholder wp-post-image" width="300" height="">';
					...
					}elseif($info)
					{
						...
						echo '<img src="'.$final_thumbnail.'" alt="Placeholder" class="woocommerce-placeholder wp-post-image" width="300" height="">';
					}elseif ($zip_file) 
					{
						# code...
